...
}:
{
  ...
  nodes.${globals.services.loki.host}.age.secrets.loki-basic-auth-hashes.generator.dependencies = [
      ...
      clients = [
        {
          ...
          url = "http://${nodes.${globals.services.loki.host}.config.wireguard.monitoring.ipv4}:${
            builtins.toString
