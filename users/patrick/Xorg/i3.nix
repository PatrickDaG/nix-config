    ...
    { config, ... }:
    {
      ...
      xsession.windowManager.i3 = {
        ...
        config = {
          startup = [
            {
              command = "${pkgs.xrandr}/bin/xrandr --output DVI-D-0 --mode 1920x1080 --pos 0x0 --rate 60.00 --output DP-4 --mode 2560x1440 --pos 1920x720 --primary --rate 144 --output HDMI-0 --pos 0x1080 --rate 60.00";
            }
          ];
          menu = "rofi -show drun";
          keybindings =
